...
export function LoginForm({
	...
	region,
	...props
}: React.ComponentProps<"form"> & { region: string }) {
	...
	const handleEmailLogin = async (e: React.FormEvent) => {
		...
		try {
			...
			finishLoadingError(
				toastId,
				error instanceof Error ? error.message : tm("error"),
			);
		} finally {
					...
					<>
						...
						<Field>
							...
							>
								...
								{oauthProvider === "google"
									? t("oauthRedirectingGoogle")
									: l("google")}
							</Button>
							{isOAuthLoading && (
								<p className="text-xs text-muted-foreground">
									{t("oauthRedirectingHint")}
								</p>
							)}
						</Field>
					</>
